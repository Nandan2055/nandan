...
import org.apache.hadoop.mapreduce.lib.output.FileOutputFormat;
 ...
 public class DegreeQuals {
 
 public static class MapperDegreeQuals extends Mapper <Object, Text, Text, Text>  {
	...
	public static class csvReducerDegreeQuals extends Reducer <Text, Text, Text, Text> {
 ...
 public static void main(String[] args) throws Exception {
	...
	job.setJarByClass(DegreeQuals.class);
	job.setMapperClass(MapperDegreeQuals.class);
	job.setReducerClass(csvReducerdDegreeQuals.class);
